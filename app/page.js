      ...
      <div class="max-w-2xl mx-auto pt-14">
        <form>
          ...
          <button
            ...
            class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:bg-green-950 hover:bg-green-950"
          >
            Copy Text
          </button>
        </form>
